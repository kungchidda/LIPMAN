...
<!-- 			</a> -->
 	...
 	<div id="tab_example">
		...
		<form class="registerForm" method="post" action="/pay/withdrawModify">
			<div id="t1" class="tab1-content">
				<input type="hidden" name="wno" value='${withdrawVO.wno}' required>
				<input type="hidden" name="uid" value='${login.uid}' required>
				<input type="hidden" name="type" value="1" required>
				<input type="number" name="registedNo" placeholder="주민등록번호를 입력해주세요.(숫자만)" class="number" value="${withdrawVO.registedNo}" required>
				<input type="text" placeholder="이름을 입력해주세요." class="name" name="ceoName" value="${withdrawVO.ceoName}" required>
				...
				<input type="number" name="accountNo" placeholder="계좌번호를 입력해주세요." class="account" value="${withdrawVO.registedNo}" required>
				<input type="text" name="accountHolder" placeholder="예금주명을 입력해주세요." class="account-name" value="${withdrawVO.accountHolder}" required>
		...
		<form class="registerForm" method="post" action="/pay/withdrawModify">
		        <div id="t2" class="tab2-content">
		            ...
		            <input type="number" name="registedNo" placeholder="사업자등록번호를 입력해주세요.(숫자만)" class="number" value="${withdrawVO.registedNo}" required>
		            <input type="text" name="companyName" placeholder="사업자명을 입력해주세요." class="name" value="${withdrawVO.companyName}" required>
		            <input type="text" name="ceoName" placeholder="대표자명을 입력해주세요." class="leader" value="${withdrawVO.ceoName}" required>
		            <select name="taxType" class="taxation" required>
		            ...
		            <input type="number" name="accountNo" placeholder="계좌번호를 입력해주세요." class="account" value="${withdrawVO.accountNo}" required>
		            <input type="text" name="accountHolder" placeholder="예금주명을 입력해주세요." class="account-name" value="${withdrawVO.accountHolder}" required>
